...
/*
int main(){
    std::string text = "This is me";
    std::unique_ptr<hfTree> huffmanTree_single = std::make_unique<hfTree>(text, hfTree::Option::MultiChar);
    std::map<std::string, std::string> codingTable = huffmanTree_single->getCodingTable();
